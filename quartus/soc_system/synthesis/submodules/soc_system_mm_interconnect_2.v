...
module soc_system_mm_interconnect_2 (
	...
	wire          rsp_mux_src_valid;                                                  // rsp_mux:src_valid -> gpu_avl_index_agent:rp_valid
	wire  [121:0] rsp_mux_src_data;                                                   // rsp_mux:src_data -> gpu_avl_index_agent:rp_data
	wire          rsp_mux_src_ready;                                                  // gpu_avl_index_agent:rp_ready -> rsp_mux:src_ready
	wire    [2:0] rsp_mux_src_channel;                                                // rsp_mux:src_channel -> gpu_avl_index_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                          // rsp_mux:src_startofpacket -> gpu_avl_index_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                            // rsp_mux:src_endofpacket -> gpu_avl_index_agent:rp_endofpacket
	...
	wire          rsp_mux_001_src_valid;                                              // rsp_mux_001:src_valid -> gpu_avl_vertex_agent:rp_valid
	wire  [121:0] rsp_mux_001_src_data;                                               // rsp_mux_001:src_data -> gpu_avl_vertex_agent:rp_data
	wire          rsp_mux_001_src_ready;                                              // gpu_avl_vertex_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                            // rsp_mux_001:src_channel -> gpu_avl_vertex_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                      // rsp_mux_001:src_startofpacket -> gpu_avl_vertex_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                        // rsp_mux_001:src_endofpacket -> gpu_avl_vertex_agent:rp_endofpacket
	...
	wire          gpu_avl_index_agent_cp_valid;                                       // gpu_avl_index_agent:cp_valid -> router:sink_valid
	wire  [121:0] gpu_avl_index_agent_cp_data;                                        // gpu_avl_index_agent:cp_data -> router:sink_data
	wire          gpu_avl_index_agent_cp_ready;                                       // router:sink_ready -> gpu_avl_index_agent:cp_ready
	wire          gpu_avl_index_agent_cp_startofpacket;                               // gpu_avl_index_agent:cp_startofpacket -> router:sink_startofpacket
	wire          gpu_avl_index_agent_cp_endofpacket;                                 // gpu_avl_index_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          gpu_avl_vertex_agent_cp_valid;                                      // gpu_avl_vertex_agent:cp_valid -> router_001:sink_valid
	wire  [121:0] gpu_avl_vertex_agent_cp_data;                                       // gpu_avl_vertex_agent:cp_data -> router_001:sink_data
	wire          gpu_avl_vertex_agent_cp_ready;                                      // router_001:sink_ready -> gpu_avl_vertex_agent:cp_ready
	wire          gpu_avl_vertex_agent_cp_startofpacket;                              // gpu_avl_vertex_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          gpu_avl_vertex_agent_cp_endofpacket;                                // gpu_avl_vertex_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire          jtag_hps_master_agent_cp_valid;                                     // jtag_hps_master_agent:cp_valid -> router_002:sink_valid
	wire  [121:0] jtag_hps_master_agent_cp_data;                                      // jtag_hps_master_agent:cp_data -> router_002:sink_data
	wire          jtag_hps_master_agent_cp_ready;                                     // router_002:sink_ready -> jtag_hps_master_agent:cp_ready
	wire          jtag_hps_master_agent_cp_startofpacket;                             // jtag_hps_master_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          jtag_hps_master_agent_cp_endofpacket;                               // jtag_hps_master_agent:cp_endofpacket -> router_002:sink_endofpacket
	wire          hps_0_f2h_axi_slave_agent_write_rp_valid;                           // hps_0_f2h_axi_slave_agent:write_rp_valid -> router_003:sink_valid
	wire  [229:0] hps_0_f2h_axi_slave_agent_write_rp_data;                            // hps_0_f2h_axi_slave_agent:write_rp_data -> router_003:sink_data
	...
	wire  [229:0] hps_0_f2h_axi_slave_agent_read_rp_data;                             // hps_0_f2h_axi_slave_agent:read_rp_data -> router_004:sink_data
	...
	wire          router_002_src_valid;                                               // router_002:src_valid -> jtag_hps_master_limiter:cmd_sink_valid
	wire  [121:0] router_002_src_data;                                                // router_002:src_data -> jtag_hps_master_limiter:cmd_sink_data
	wire          router_002_src_ready;                                               // jtag_hps_master_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [2:0] router_002_src_channel;                                             // router_002:src_channel -> jtag_hps_master_limiter:cmd_sink_channel
	wire          router_002_src_startofpacket;                                       // router_002:src_startofpacket -> jtag_hps_master_limiter:cmd_sink_startofpacket
	wire          router_002_src_endofpacket;                                         // router_002:src_endofpacket -> jtag_hps_master_limiter:cmd_sink_endofpacket
	wire  [121:0] jtag_hps_master_limiter_cmd_src_data;                               // jtag_hps_master_limiter:cmd_src_data -> cmd_demux_002:sink_data
	wire          jtag_hps_master_limiter_cmd_src_ready;                              // cmd_demux_002:sink_ready -> jtag_hps_master_limiter:cmd_src_ready
	wire    [2:0] jtag_hps_master_limiter_cmd_src_channel;                            // jtag_hps_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	wire          jtag_hps_master_limiter_cmd_src_startofpacket;                      // jtag_hps_master_limiter:cmd_src_startofpacket -> cmd_demux_002:sink_startofpacket
	wire          jtag_hps_master_limiter_cmd_src_endofpacket;                        // jtag_hps_master_limiter:cmd_src_endofpacket -> cmd_demux_002:sink_endofpacket
	wire          rsp_mux_002_src_valid;                                              // rsp_mux_002:src_valid -> jtag_hps_master_limiter:rsp_sink_valid
	wire  [121:0] rsp_mux_002_src_data;                                               // rsp_mux_002:src_data -> jtag_hps_master_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                              // jtag_hps_master_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                            // rsp_mux_002:src_channel -> jtag_hps_master_limiter:rsp_sink_channel
	wire          rsp_mux_002_src_startofpacket;                                      // rsp_mux_002:src_startofpacket -> jtag_hps_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                        // rsp_mux_002:src_endofpacket -> jtag_hps_master_limiter:rsp_sink_endofpacket
	wire          jtag_hps_master_limiter_rsp_src_valid;                              // jtag_hps_master_limiter:rsp_src_valid -> jtag_hps_master_agent:rp_valid
	wire  [121:0] jtag_hps_master_limiter_rsp_src_data;                               // jtag_hps_master_limiter:rsp_src_data -> jtag_hps_master_agent:rp_data
	wire          jtag_hps_master_limiter_rsp_src_ready;                              // jtag_hps_master_agent:rp_ready -> jtag_hps_master_limiter:rsp_src_ready
	wire    [2:0] jtag_hps_master_limiter_rsp_src_channel;                            // jtag_hps_master_limiter:rsp_src_channel -> jtag_hps_master_agent:rp_channel
	...
	wire  [121:0] cmd_demux_002_src0_data;                                            // cmd_demux_002:src0_data -> cmd_mux:sink2_data
	...
	wire  [121:0] cmd_demux_002_src1_data;                                            // cmd_demux_002:src1_data -> cmd_mux_001:sink2_data
	...
	wire  [121:0] rsp_demux_src2_data;                                                // rsp_demux:src2_data -> rsp_mux_002:sink0_data
	...
	wire  [121:0] rsp_demux_001_src2_data;                                            // rsp_demux_001:src2_data -> rsp_mux_002:sink1_data
	...
	wire  [121:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> hps_0_f2h_axi_slave_wr_cmd_width_adapter:in_data
	...
	wire  [229:0] hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_data;                  // hps_0_f2h_axi_slave_wr_cmd_width_adapter:out_data -> hps_0_f2h_axi_slave_agent:write_cp_data
	...
	wire    [2:0] hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_channel;               // hps_0_f2h_axi_slave_wr_cmd_width_adapter:out_channel -> hps_0_f2h_axi_slave_agent:write_cp_channel
	...
	wire  [121:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> hps_0_f2h_axi_slave_rd_cmd_width_adapter:in_data
	...
	wire  [229:0] hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_data;                  // hps_0_f2h_axi_slave_rd_cmd_width_adapter:out_data -> hps_0_f2h_axi_slave_agent:read_cp_data
	...
	wire    [2:0] hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_channel;               // hps_0_f2h_axi_slave_rd_cmd_width_adapter:out_channel -> hps_0_f2h_axi_slave_agent:read_cp_channel
	...
	wire  [229:0] router_003_src_data;                                                // router_003:src_data -> hps_0_f2h_axi_slave_wr_rsp_width_adapter:in_data
	...
	wire  [121:0] hps_0_f2h_axi_slave_wr_rsp_width_adapter_src_data;                  // hps_0_f2h_axi_slave_wr_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [229:0] router_004_src_data;                                                // router_004:src_data -> hps_0_f2h_axi_slave_rd_rsp_width_adapter:in_data
	...
	wire  [121:0] hps_0_f2h_axi_slave_rd_rsp_width_adapter_src_data;                  // hps_0_f2h_axi_slave_rd_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire  [121:0] cmd_demux_src0_data;                                                // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [121:0] crosser_out_data;                                                   // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [121:0] cmd_demux_src1_data;                                                // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [121:0] crosser_001_out_data;                                               // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [121:0] cmd_demux_001_src0_data;                                            // cmd_demux_001:src0_data -> crosser_002:in_data
	...
	wire  [121:0] crosser_002_out_data;                                               // crosser_002:out_data -> cmd_mux:sink1_data
	...
	wire  [121:0] rsp_demux_src0_data;                                                // rsp_demux:src0_data -> crosser_004:in_data
	wire          rsp_demux_src0_ready;                                               // crosser_004:in_ready -> rsp_demux:src0_ready
	wire    [2:0] rsp_demux_src0_channel;                                             // rsp_demux:src0_channel -> crosser_004:in_channel
	...
	wire  [121:0] crosser_004_out_data;                                               // crosser_004:out_data -> rsp_mux:sink0_data
	wire          crosser_004_out_ready;                                              // rsp_mux:sink0_ready -> crosser_004:out_ready
	wire    [2:0] crosser_004_out_channel;                                            // crosser_004:out_channel -> rsp_mux:sink0_channel
	...
	wire  [121:0] rsp_demux_src1_data;                                                // rsp_demux:src1_data -> crosser_005:in_data
	wire          rsp_demux_src1_ready;                                               // crosser_005:in_ready -> rsp_demux:src1_ready
	wire    [2:0] rsp_demux_src1_channel;                                             // rsp_demux:src1_channel -> crosser_005:in_channel
	...
	wire  [121:0] crosser_005_out_data;                                               // crosser_005:out_data -> rsp_mux_001:sink0_data
	wire          crosser_005_out_ready;                                              // rsp_mux_001:sink0_ready -> crosser_005:out_ready
	wire    [2:0] crosser_005_out_channel;                                            // crosser_005:out_channel -> rsp_mux_001:sink0_channel
	...
	wire  [121:0] rsp_demux_001_src0_data;                                            // rsp_demux_001:src0_data -> crosser_006:in_data
	wire          rsp_demux_001_src0_ready;                                           // crosser_006:in_ready -> rsp_demux_001:src0_ready
	wire    [2:0] rsp_demux_001_src0_channel;                                         // rsp_demux_001:src0_channel -> crosser_006:in_channel
	...
	wire  [121:0] crosser_006_out_data;                                               // crosser_006:out_data -> rsp_mux:sink1_data
	wire          crosser_006_out_ready;                                              // rsp_mux:sink1_ready -> crosser_006:out_ready
	wire    [2:0] crosser_006_out_channel;                                            // crosser_006:out_channel -> rsp_mux:sink1_channel
	...
	wire  [121:0] rsp_demux_001_src1_data;                                            // rsp_demux_001:src1_data -> crosser_007:in_data
	wire          rsp_demux_001_src1_ready;                                           // crosser_007:in_ready -> rsp_demux_001:src1_ready
	wire    [2:0] rsp_demux_001_src1_channel;                                         // rsp_demux_001:src1_channel -> crosser_007:in_channel
	...
	wire  [121:0] crosser_007_out_data;                                               // crosser_007:out_data -> rsp_mux_001:sink1_data
	wire          crosser_007_out_ready;                                              // rsp_mux_001:sink1_ready -> crosser_007:out_ready
	wire    [2:0] crosser_007_out_channel;                                            // crosser_007:out_channel -> rsp_mux_001:sink1_channel
	...
	wire    [2:0] jtag_hps_master_limiter_cmd_valid_data;                             // jtag_hps_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	soc_system_mm_interconnect_2_router_003 router_004 (
