...
module soc_system_mm_interconnect_4 (
		...
		input  wire        vga_pll_outclk1_clk,                                               //                                             vga_pll_outclk1.clk
	...
	wire   [20:0] video_pixel_buffer_dma_0_avalon_control_slave_agent_m0_address;                    // video_pixel_buffer_dma_0_avalon_control_slave_agent:m0_address -> video_pixel_buffer_dma_0_avalon_control_slave_translator:uav_address
	...
	wire          video_pixel_buffer_dma_0_avalon_control_slave_agent_rp_valid;                      // video_pixel_buffer_dma_0_avalon_control_slave_agent:rp_valid -> router_002:sink_valid
	wire  [111:0] video_pixel_buffer_dma_0_avalon_control_slave_agent_rp_data;                       // video_pixel_buffer_dma_0_avalon_control_slave_agent:rp_data -> router_002:sink_data
	wire          video_pixel_buffer_dma_0_avalon_control_slave_agent_rp_ready;                      // router_002:sink_ready -> video_pixel_buffer_dma_0_avalon_control_slave_agent:rp_ready
	wire          video_pixel_buffer_dma_0_avalon_control_slave_agent_rp_startofpacket;              // video_pixel_buffer_dma_0_avalon_control_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          video_pixel_buffer_dma_0_avalon_control_slave_agent_rp_endofpacket;                // video_pixel_buffer_dma_0_avalon_control_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                                                 // cmd_mux:src_valid -> video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                                 // video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                               // cmd_mux:src_channel -> video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                                         // cmd_mux:src_startofpacket -> video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                                           // cmd_mux:src_endofpacket -> video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:sink0_endofpacket
	wire          video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_valid;         // video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:source0_valid -> video_pixel_buffer_dma_0_avalon_control_slave_agent:cp_valid
	wire  [111:0] video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_data;          // video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:source0_data -> video_pixel_buffer_dma_0_avalon_control_slave_agent:cp_data
	wire          video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_ready;         // video_pixel_buffer_dma_0_avalon_control_slave_agent:cp_ready -> video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:source0_ready
	wire    [1:0] video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_channel;       // video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:source0_channel -> video_pixel_buffer_dma_0_avalon_control_slave_agent:cp_channel
	wire          video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_startofpacket; // video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:source0_startofpacket -> video_pixel_buffer_dma_0_avalon_control_slave_agent:cp_startofpacket
	wire          video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_endofpacket;   // video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter:source0_endofpacket -> video_pixel_buffer_dma_0_avalon_control_slave_agent:cp_endofpacket
	...
	wire          video_pixel_buffer_dma_0_avalon_control_slave_agent_rdata_fifo_out_valid;          // video_pixel_buffer_dma_0_avalon_control_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] video_pixel_buffer_dma_0_avalon_control_slave_agent_rdata_fifo_out_data;           // video_pixel_buffer_dma_0_avalon_control_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          video_pixel_buffer_dma_0_avalon_control_slave_agent_rdata_fifo_out_ready;          // avalon_st_adapter:in_0_ready -> video_pixel_buffer_dma_0_avalon_control_slave_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_channel),       //                .channel
	...
	soc_system_mm_interconnect_4_router router_001 (
	...
	soc_system_mm_interconnect_4_router_002 router_002 (
	...
	soc_system_mm_interconnect_4_router_002 router_003 (
	...
	altera_merlin_burst_adapter #(
	...
	) video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter (
		.clk                   (vga_pll_outclk1_clk),                                                               //       cr0.clk
		...
		.source0_valid         (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (video_pixel_buffer_dma_0_avalon_control_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_4_cmd_demux cmd_demux_001 (
		.clk                (clk_clk_clk),                                                       //       clk.clk
		.reset              (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_4_rsp_demux_001 rsp_demux_001 (
		.clk                (gpu_pll_outclk0_clk),                   //       clk.clk
		.reset              (gpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_4_rsp_mux rsp_mux_001 (
		.clk                 (clk_clk_clk),                                                       //       clk.clk
		.reset               (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_dc_fifo #(
		...
		.out_clk           (vga_pll_outclk1_clk),                                                //       out_clk.clk
		.out_reset_n       (~video_pixel_buffer_dma_0_reset_reset_bridge_in_reset_reset),        // out_clk_reset.reset_n
	...
	altera_avalon_dc_fifo #(
		...
		.in_clk            (vga_pll_outclk1_clk),                                                //        in_clk.clk
		.in_reset_n        (~video_pixel_buffer_dma_0_reset_reset_bridge_in_reset_reset),        //  in_clk_reset.reset_n
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (vga_pll_outclk1_clk),                                                      // in_clk_0.clk
