...
module soc_system_mm_interconnect_4 (
	...
	wire          rsp_mux_src_valid;                                             // rsp_mux:src_valid -> vga_master_agent:rp_valid
	wire  [109:0] rsp_mux_src_data;                                              // rsp_mux:src_data -> vga_master_agent:rp_data
	wire          rsp_mux_src_ready;                                             // vga_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                           // rsp_mux:src_channel -> vga_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                     // rsp_mux:src_startofpacket -> vga_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                       // rsp_mux:src_endofpacket -> vga_master_agent:rp_endofpacket
	...
	wire          vga_master_agent_cp_valid;                                     // vga_master_agent:cp_valid -> router:sink_valid
	wire  [109:0] vga_master_agent_cp_data;                                      // vga_master_agent:cp_data -> router:sink_data
	wire          vga_master_agent_cp_ready;                                     // router:sink_ready -> vga_master_agent:cp_ready
	wire          vga_master_agent_cp_startofpacket;                             // vga_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          vga_master_agent_cp_endofpacket;                               // vga_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [109:0] cmd_mux_src_data;                                              // cmd_mux:src_data -> hps_0_f2h_sdram0_data_cmd_width_adapter:in_data
	...
	wire  [109:0] hps_0_f2h_sdram0_data_rsp_width_adapter_src_data;              // hps_0_f2h_sdram0_data_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire   [65:0] hps_0_f2h_sdram0_data_agent_rdata_fifo_src_data;               // hps_0_f2h_sdram0_data_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	...
	soc_system_mm_interconnect_4_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
