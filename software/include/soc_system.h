...
/*
 * Macros for device 'gpu', class 'gpu'
 * The macros are prefixed with 'GPU_'.
 * The prefix is the slave descriptor.
 */
#define GPU_COMPONENT_TYPE gpu
#define GPU_COMPONENT_NAME gpu
#define GPU_BASE 0xff200000
#define GPU_SPAN 4096
#define GPU_END 0xff200fff
...
#define VIDEO_PIXEL_BUFFER_DMA_0_BASE 0xff220000
#define VIDEO_PIXEL_BUFFER_DMA_0_SPAN 16
#define VIDEO_PIXEL_BUFFER_DMA_0_END 0xff22000f
...
/*
 * Macros for device 'hps_qspi_axi_slave0', class 'cadence_qspi'
 * The macros are prefixed with 'HPS_QSPI_AXI_SLAVE0_'.
 * The prefix is the slave descriptor.
 */
#define HPS_QSPI_AXI_SLAVE0_COMPONENT_TYPE cadence_qspi
#define HPS_QSPI_AXI_SLAVE0_COMPONENT_NAME hps_qspi
#define HPS_QSPI_AXI_SLAVE0_BASE 0xff705000
#define HPS_QSPI_AXI_SLAVE0_SPAN 256
#define HPS_QSPI_AXI_SLAVE0_END 0xff7050ff

/*
 * Macros for device 'hps_fpgamgr_axi_slave0', class 'altera_fpgamgr'
 * The macros are prefixed with 'HPS_FPGAMGR_AXI_SLAVE0_'.
 * The prefix is the slave descriptor.
 */
#define HPS_FPGAMGR_AXI_SLAVE0_COMPONENT_TYPE altera_fpgamgr
#define HPS_FPGAMGR_AXI_SLAVE0_COMPONENT_NAME hps_fpgamgr
#define HPS_FPGAMGR_AXI_SLAVE0_BASE 0xff706000
#define HPS_FPGAMGR_AXI_SLAVE0_SPAN 4096
#define HPS_FPGAMGR_AXI_SLAVE0_END 0xff706fff
...
/*
 * Macros for device 'hps_nand0_axi_slave0', class 'denali_nand'
 * The macros are prefixed with 'HPS_NAND0_AXI_SLAVE0_'.
 * The prefix is the slave descriptor.
 */
#define HPS_NAND0_AXI_SLAVE0_COMPONENT_TYPE denali_nand
#define HPS_NAND0_AXI_SLAVE0_COMPONENT_NAME hps_nand0
#define HPS_NAND0_AXI_SLAVE0_BASE 0xff900000
#define HPS_NAND0_AXI_SLAVE0_SPAN 65536
#define HPS_NAND0_AXI_SLAVE0_END 0xff90ffff

/*
 * Macros for device 'hps_qspi_axi_slave1', class 'cadence_qspi'
 * The macros are prefixed with 'HPS_QSPI_AXI_SLAVE1_'.
 * The prefix is the slave descriptor.
 */
#define HPS_QSPI_AXI_SLAVE1_COMPONENT_TYPE cadence_qspi
#define HPS_QSPI_AXI_SLAVE1_COMPONENT_NAME hps_qspi
#define HPS_QSPI_AXI_SLAVE1_BASE 0xffa00000
#define HPS_QSPI_AXI_SLAVE1_SPAN 256
#define HPS_QSPI_AXI_SLAVE1_END 0xffa000ff
...
/*
 * Macros for device 'hps_nand0_axi_slave1', class 'denali_nand'
 * The macros are prefixed with 'HPS_NAND0_AXI_SLAVE1_'.
 * The prefix is the slave descriptor.
 */
#define HPS_NAND0_AXI_SLAVE1_COMPONENT_TYPE denali_nand
#define HPS_NAND0_AXI_SLAVE1_COMPONENT_NAME hps_nand0
#define HPS_NAND0_AXI_SLAVE1_BASE 0xffb80000
#define HPS_NAND0_AXI_SLAVE1_SPAN 65536
#define HPS_NAND0_AXI_SLAVE1_END 0xffb8ffff

/*
 * Macros for device 'hps_fpgamgr_axi_slave1', class 'altera_fpgamgr'
 * The macros are prefixed with 'HPS_FPGAMGR_AXI_SLAVE1_'.
 * The prefix is the slave descriptor.
 */
#define HPS_FPGAMGR_AXI_SLAVE1_COMPONENT_TYPE altera_fpgamgr
#define HPS_FPGAMGR_AXI_SLAVE1_COMPONENT_NAME hps_fpgamgr
#define HPS_FPGAMGR_AXI_SLAVE1_BASE 0xffb90000
#define HPS_FPGAMGR_AXI_SLAVE1_SPAN 256
#define HPS_FPGAMGR_AXI_SLAVE1_END 0xffb900ff
...
/*
 * Macros for device 'hps_arm_gic_0_axi_slave1', class 'arm_gic'
 * The macros are prefixed with 'HPS_ARM_GIC_0_AXI_SLAVE1_'.
 * The prefix is the slave descriptor.
 */
#define HPS_ARM_GIC_0_AXI_SLAVE1_COMPONENT_TYPE arm_gic
#define HPS_ARM_GIC_0_AXI_SLAVE1_COMPONENT_NAME hps_arm_gic_0
#define HPS_ARM_GIC_0_AXI_SLAVE1_BASE 0xfffec100
#define HPS_ARM_GIC_0_AXI_SLAVE1_SPAN 256
#define HPS_ARM_GIC_0_AXI_SLAVE1_END 0xfffec1ff
...
/*
 * Macros for device 'hps_arm_gic_0_axi_slave0', class 'arm_gic'
 * The macros are prefixed with 'HPS_ARM_GIC_0_AXI_SLAVE0_'.
 * The prefix is the slave descriptor.
 */
#define HPS_ARM_GIC_0_AXI_SLAVE0_COMPONENT_TYPE arm_gic
#define HPS_ARM_GIC_0_AXI_SLAVE0_COMPONENT_NAME hps_arm_gic_0
#define HPS_ARM_GIC_0_AXI_SLAVE0_BASE 0xfffed000
#define HPS_ARM_GIC_0_AXI_SLAVE0_SPAN 4096
#define HPS_ARM_GIC_0_AXI_SLAVE0_END 0xfffedfff
