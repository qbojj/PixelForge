...
Aplikacja \code{demo\_depth} renderuje cztery sześciany obracające się w przestrzeni 3D, które czasami się przysłaniają, demonstrujący test głębokości. Test weryfikuje:
\begin{itemize}
...
Pozwoliłoby to na oddzielenie fazy rasteryzacji od magistrali pamięci, co pozwoliłoby na osiągnięcie częstotliwości wyższych niż maksymalna częstotliwość magistrali pamięci.
